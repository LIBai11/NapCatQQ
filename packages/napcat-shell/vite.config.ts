...
const ShellBaseConfigPlugin: PluginOption[] = [
  ...
  cp({
    targets: [
      ...
      { src: '../../node_modules/express', dest: 'dist/node_modules', flatten: false },
      { src: '../../node_modules/ws', dest: 'dist/node_modules', flatten: false },
      { src: '../../node_modules/silk-wasm', dest: 'dist/node_modules', flatten: false },
    ],
  }),
  nodeResolve(),
  napcatVersion(),
